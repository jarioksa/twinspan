...
c     WRITE (IUOUT2,1000) LEVEL
c     1000 FORMAT(/'   END OF LEVEL',I4,//)
      LEVEL=LEVEL+1
      IF (LEVEL.LE.LEVMAX) GOTO 80
 60   ISTOP=1
c     WRITE (IUOUT2,1001)
c     1001 FORMAT(/'THIS IS THE END OF THE DIVISIONS REQUESTED')
      DO 70 II=1,MM
         IC=ICLASS(II)
