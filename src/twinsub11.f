...
C---FOLLOWING COMMON BLOCK ADDED BY P.R.MINCHIN SEPT 1986
 ...
 1001 FORMAT('***ERROR***  DATA ARRAY NEEDS',I6,' ELEMENTS')
      STOP
   40 IID=NDAT
   80 IDAT(IID)=IDAT(ID)
      ID=ID-1
...
C TO DO IS TO CONDENSE THE NUMBERING
 ...
 1002 FORMAT(//'LENGTH OF DATA ARRAY AFTER DEFINING PSEUDOSPECIES',
     1I7)
      IF(ID*2.GT.NDAT) WRITE (IUOUT2,1003) NDAT
      IF(ID*2.GT.NDAT) WRITE (IUOUT1,1003) NDAT
 1003 FORMAT('*** BEWARE ***  THIS EXCEEDS ONE-HALF LENGTH OF',
     1' DATA ARRAY (=',I6,')'/
     2'NO SPECIES CLASSIFICATION CAN BE PERFORMED')
      NN=IP
      IF(NN.LE.NMAX) GOTO 155
      WRITE (IUOUT2,1000) NN
      WRITE (IUOUT1,1000) NN
 1000 FORMAT('***ERROR*** - NEEDS DIMENSIONING FOR',I6,
     1'  PSEUDOSPECIES')
      STOP
  155 NSPEC=JTOP(1)
      WRITE (IUOUT2,1004) NN
      WRITE (IUOUT1,1004) NN
 1004 FORMAT(//'TOTAL NUMBER OF SPECIES AND PSEUDOSPECIES',I7)
      WRITE (IUOUT2,1005) NSPEC
      WRITE (IUOUT1,1005) NSPEC
 1005 FORMAT(//'NUMBER OF SPECIES, EXCLUDING PSEUDOSPECIES ',
