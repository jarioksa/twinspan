...
C NOW FIND BEST NUMBER OF INDICATORS AND BEST DIVISION POINT
   ...
   70 CONTINUE
      ...
      WRITE (IUOUT2,1003)
 1003 FORMAT('INDICATORS, TOGETHER WITH THEIR SIGN')
      IT=0
      DO 80 IIND=1,IND
      J=INDORD(IIND)
      JJ=JJCOL(J)
...
C 1004 FORMAT((7(A4,1X,A4,I1,'(',A1,')',3X)))
 1004 FORMAT((7(A4,1X,A4,A1,'(',A1,')',3X)))
      GOTO 120
  100 DO 110 I=1,M
  110 IX(I)=0
      MS=1
 ...
 1006 FORMAT('(NO INDICATORS)')
c  120 CALL REPORT(M,MM,N,NN,NDAT,MMZ,MMS,IC,X,XX,ROWWGT,
